...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say (score0, score1):
        ...
        if who == 0:
            if score0 - last_score > cur_high:
                cur_high = score0 - last_score
                print (cur_high, "point(s)! That's a record gain for Player", who, "!")
            return announce_highest (who, score0, cur_high)
        else:
            if score1 - last_score > cur_high:
                cur_high = score1 - last_score
                print (cur_high, "point(s)! That's a record gain for Player 1!")
            return announce_highest (who, score1, cur_high)
    return say
