...
def MDH (i, cur, count):
    ...
    if i == cur % 10:
        return MDH (i - 1, cur // 10, count)
    elif i > cur % 10:
        return MDH (i - 1, cur, count + 1)
    elif i < cur % 10:
        return MDH (i, cur // 10, count)
...
def CCH (change, coin):
    if change == 0:
        ...
        return CCH (change, descending_coin (coin))
    else:
        return CCH (change - coin, coin) + CCH (change, descending_coin (coin))
